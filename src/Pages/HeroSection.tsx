...
//         if (response.data && response.data.length > 0) {
//           const fetchedProducts = response.data.slice(0, 9).map((item, index) => {
//             console.log("Item:", item); // ✅ Now item is defined
//             console.log("Index:", index); // ✅ Now index is defined
...
//   const itemTemplate = (product) => {
//     if (!product || !product.id) return <div>No Product Found</div>; // ✅ Prevents undefined error
